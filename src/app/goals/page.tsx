        ...
        <div className="p-6 space-y-6">
            ...
            <ul className="space-y-3">
                {goals.map((g) => (
                    <li
                        key={g.id}
                        className={`px-3 py-2 rounded flex justify-between items-center ${g.completed ? "bg-green-200" : "bg-silver-100"
                            }`}
                    >
                        <div>
            ...
            <div className="bg-silver-100 text-slate-900 p-4 rounded space-y-2">
                ...
                <p className="text-sm text-silver-600">Target: {targetPoints} pts</p>
            </div>
        </div>
    );
}
